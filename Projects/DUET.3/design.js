function Design(mwidth) {
    ...
    if (inwidth.value == "0") {
        ...
        var paneldesign = document.getElementById("DIVB");
...
Design.prototype.save = function() {
    ...
    if (this.dataURL[design.index].length > 0) {
        ...
        var divdesigns = document.getElementById("designsteps");
        if (divdesigns.innerHTML == 0) {
            divdesigns.appendChild(adiv)
        } else {
            divdesigns.insertBefore(adiv, divdesigns.childNodes[0]);
        }
